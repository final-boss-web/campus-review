...
import { ShieldAlert, Sparkles, Mail, Lock, CheckCircle, ArrowLeft } from 'lucide-react';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.response?.data?.needsVerification) {
        ...
        // Redirect to verify registration with email prefilled
        setTimeout(() => {
          navigate(`/verify-registration?email=${encodeURIComponent(err.response.data.email)}`);
        }, 2000);
      } else {
